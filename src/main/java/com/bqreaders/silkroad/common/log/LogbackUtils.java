package com.bqreaders.silkroad.common.log;
...
public final class LogbackUtils {
	...
	public static boolean setLogLevel(String logLevel) {
		return setLogLevel(null, logLevel);
	}
	...
	public static boolean setLogLevel(String loggerName, String logLevel) {
		...
		try {
			...
			logger.warn("Couldn't set log level to {} for the logger '{}'", new Object[] { logLevelUpper, loggerName },
					e);
			return false;
		}
	}
