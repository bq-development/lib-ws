...
/**
 * @author Fork from Dropwizard 0.7.1 Francisco Sanchez
 */
public class SilkroadJacksonMessageBodyProvider extends JacksonJaxbJsonProvider {
    /**
    ...
    public SilkroadJacksonMessageBodyProvider(ObjectMapper mapper, Validator validator) {
